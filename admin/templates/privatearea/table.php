<table>
	<thead>
		<tr>
			<th class="border-bottom-2 border-mute-light fore-color-1"><?php echo l10n("private_area_username", "Username") ?></th>
	...
	<?php $i = 0; foreach ($users as $user): $i++ ?>
		<tr id="id_<?php echo $user['id']?>" class="<?php echo $i % 2 == 0 ? 'background-blue-light' : '' ?>">
			...
			<td class="<?php echo $i % 2 ? 'even-dark' : 'odd-dark' ?>">
				...
				<?php endif; ?>
				<a class="fa margin-left icon-large fa-key fore-yellow" href="privatearea.php?passwordemail=<?php echo urlencode($user['username']) ?>" title="<?php echo l10n("private_area_send_password", "Email the password to this user") ?>"></a>
			</td>
		</tr>
	<?php endforeach; ?>
<?php endif; ?>
